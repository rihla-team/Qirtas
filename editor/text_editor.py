...
class ArabicEditor(QMainWindow):
    ...
    def __init__(self):
        ...
        try:
            ...
            with open(templates_path, 'r', encoding='utf-8') as f:
                ...
                templates = list(templates_data.keys())
        except Exception as e:
    ...
    def init_ui(self):
        ...
        # إنشاء مقسم عمودي للمحرر والطرفية
        ...
        # إنشاء حاوية الطرفية (مخفية في البداية)
        ...
        # إضافة حاوية الطرفية إلى المقسم
        ...
        self.main_splitter.setStretchFactor(1, 3)  # الطرفية
